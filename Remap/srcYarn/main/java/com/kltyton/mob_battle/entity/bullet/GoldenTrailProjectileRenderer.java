...
public class GoldenTrailProjectileRenderer extends EntityRenderer<GoldenTrailProjectile, ArrowEntityRenderState> {
    public static final Identifier TEXTURE = Identifier.of(Mob_battle.MOD_ID, "textures/entity/projectiles/golden_trail_projectile.png");
    public static final Identifier TIPPED_TEXTURE = Identifier.ofVanilla("textures/entity/projectiles/golden_trail_projectile.png");
    private final GoldenTrailProjectileModel model;

    public GoldenTrailProjectileRenderer(EntityRendererFactory.Context context) {
        super(context);
        this.model = new GoldenTrailProjectileModel(context.getPart(ModModel.GOLDEN_TRAIL_PROJECTILE));
    }
    ...
    @Override
    public void updateRenderState(GoldenTrailProjectile persistentProjectileEntity, ArrowEntityRenderState projectileEntityRenderState, float f) {
