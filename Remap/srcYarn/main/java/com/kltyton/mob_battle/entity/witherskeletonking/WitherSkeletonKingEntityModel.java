...
public class WitherSkeletonKingEntityModel extends GeoModel<WitherSkeletonKingEntity> {
    private final Identifier model = Identifier.of(Mob_battle.MOD_ID, "wither_skeleton_king");
    private final Identifier animations = Identifier.of(Mob_battle.MOD_ID, "wither_skeleton_king");
    private final Identifier texture = Identifier.of(Mob_battle.MOD_ID, "textures/entity/wither_skeleton_king/wither_skeleton_king.png");
