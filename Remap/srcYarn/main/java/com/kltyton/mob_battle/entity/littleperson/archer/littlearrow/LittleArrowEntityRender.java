...
public class LittleArrowEntityRender extends EntityRenderer<LittleArrowEntity, ArrowEntityRenderState> {
    public static final Identifier TEXTURE = Identifier.of(Mob_battle.MOD_ID, "textures/entity/projectiles/little_arrow.png");
    ...
    public LittleArrowEntityRender(EntityRendererFactory.Context context) {
        super(context);
        this.model = new LittleArrowEntityModel(context.getPart(ModModel.LITTLE_ARROW));
    }
    @Override
