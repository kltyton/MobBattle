...
public class ModScreenHandlers {
    ...
    public static void init() {
        Registry.register(BuiltInRegistries.MENU, Identifier.fromNamespaceAndPath(Mob_battle.MOD_ID, "paged_backpack"), PAGED_BACKPACK);
        Registry.register(BuiltInRegistries.MENU, Identifier.fromNamespaceAndPath(Mob_battle.MOD_ID, "mechanical_worktable"), MECHANICAL_WORKTABLE);
    }
}
