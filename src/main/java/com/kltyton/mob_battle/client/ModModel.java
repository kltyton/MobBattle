...
public class ModModel {
    ...
    public static final EntityModelLayer LASER = new EntityModelLayer(Identifier.of(Mob_battle.MOD_ID, "laser"), "bb_main");
    public static final EntityModelLayer SNOWMAN_ICE_BLOCK = new EntityModelLayer(Identifier.of(Mob_battle.MOD_ID, "snowman_ice_block"), "bone7");
