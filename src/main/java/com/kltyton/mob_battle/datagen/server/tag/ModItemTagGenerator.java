...
public class ModItemTagGenerator extends FabricTagsProvider.ItemTagsProvider {
    ...
    private static final TagKey<Item> ENCHANTABLE_FOOT_ARMOR = TagKey.create(Registries.ITEM, Identifier.withDefaultNamespace("enchantable/foot_armor"));

    public ModItemTagGenerator(FabricPackOutput output, CompletableFuture<HolderLookup.Provider> registriesFuture) {
