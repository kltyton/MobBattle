...
public class ModEnglishLangProvider extends FabricLanguageProvider {
    ...
    public void generateTranslations(HolderLookup.Provider registryLookup, TranslationBuilder translationBuilder) {
        ...
        translationBuilder.add(ModLangUtils.getTranslationKey(ModItems.PIGLIN_BRUTE_BOW_SPAWN_EGG), "Bow Piglin Brute Spawn Egg");
        translationBuilder.add(ModLangUtils.getTranslationKey(ModItems.PIGLIN_BRUTE_CROSSBOW_SPAWN_EGG), "Crossbow Piglin Brute Spawn Egg");
        ...
        translationBuilder.add(ModLangUtils.getTranslationKey(ModEntities.ANGRY_SILVERFISH), "Angry Silverfish");
        translationBuilder.add(ModLangUtils.getTranslationKey(ModItems.SPAWN_EGG_ITEMS.get("angry_silverfish")), "Angry Silverfish Spawn Egg");
        ...
        translationBuilder.add(ModLangUtils.getTranslationKey(ModEntities.LITTLE_PERSON_WORKER), "Little Person Worker");
        translationBuilder.add(ModLangUtils.getTranslationKey(ModItems.SPAWN_EGG_ITEMS.get("little_person_worker")), "Little Person Worker Spawn Egg");
        ...
        translationBuilder.add(ModLangUtils.getTranslationKey(ModEntities.NEW_SKULL_MAGE), "New Skeleton Mage");
        translationBuilder.add(ModLangUtils.getTranslationKey(ModItems.SPAWN_EGG_ITEMS.get("new_skull_mage")), "New Skeleton Mage Spawn Egg");
        translationBuilder.add(ModLangUtils.getTranslationKey(ModEntities.YEMO_WENLU), "Yemo Wenlu");
        translationBuilder.add(ModLangUtils.getTranslationKey(ModItems.SPAWN_EGG_ITEMS.get("yemo_wenlu")), "Yemo Wenlu Spawn Egg");
        translationBuilder.add(ModLangUtils.getTranslationKey(ModEntities.RENFU), "Renfu");
        translationBuilder.add(ModLangUtils.getTranslationKey(ModItems.SPAWN_EGG_ITEMS.get("renfu")), "Renfu Spawn Egg");
        translationBuilder.add(ModLangUtils.getTranslationKey(ModEntities.CONTRADICTION_MAN), "Contradiction Man");
        translationBuilder.add(ModLangUtils.getTranslationKey(ModItems.SPAWN_EGG_ITEMS.get("contradiction_man")), "Contradiction Man Spawn Egg");
        translationBuilder.add(ModLangUtils.getTranslationKey(ModEntities.MACE_MAN), "Mace Man");
        translationBuilder.add(ModLangUtils.getTranslationKey(ModItems.SPAWN_EGG_ITEMS.get("mace_man")), "Mace Man Spawn Egg");
        translationBuilder.add(ModLangUtils.getTranslationKey(ModEntities.LITTLE_PERSON_BOXER), "Little Person Boxer");
        translationBuilder.add(ModLangUtils.getTranslationKey(ModItems.SPAWN_EGG_ITEMS.get("little_person_boxer")), "Little Person Boxer Spawn Egg");
        translationBuilder.add(ModLangUtils.getTranslationKey(ModEntities.LITTLE_PERSON_CITY_GUARD), "Little Person City Guard");
        translationBuilder.add(ModLangUtils.getTranslationKey(ModItems.SPAWN_EGG_ITEMS.get("little_person_city_guard")), "Little Person City Guard Spawn Egg");
        translationBuilder.add(ModLangUtils.getTranslationKey(ModEntities.LITTLE_PERSON_SERVANT), "Little Person Servant");
        translationBuilder.add(ModLangUtils.getTranslationKey(ModItems.SPAWN_EGG_ITEMS.get("little_person_servant")), "Little Person Servant Spawn Egg");
        translationBuilder.add(ModLangUtils.getTranslationKey(ModEntities.SEVEN_HARVEST_LITTLE_PERSON), "Seven Harvest Little Person");
        translationBuilder.add(ModLangUtils.getTranslationKey(ModItems.SPAWN_EGG_ITEMS.get("seven_harvest_little_person")), "Seven Harvest Little Person Spawn Egg");
        translationBuilder.add(ModLangUtils.getTranslationKey(ModEntities.KNIFE_LITTLE_PERSON), "Knife Little Person");
        translationBuilder.add(ModLangUtils.getTranslationKey(ModItems.SPAWN_EGG_ITEMS.get("knife_little_person")), "Knife Little Person Spawn Egg");
        translationBuilder.add(ModLangUtils.getTranslationKey(ModEntities.XBOT002), "Xbot002.1");
        translationBuilder.add(ModLangUtils.getTranslationKey(ModItems.SPAWN_EGG_ITEMS.get("xbot002")), "Xbot002.1 Spawn Egg");
        translationBuilder.add(ModLangUtils.getTranslationKey(ModEntities.ELITE_LITTLE_PERSON_GUARD), "Elite Little Person Guard");
        translationBuilder.add(ModLangUtils.getTranslationKey(ModItems.SPAWN_EGG_ITEMS.get("elite_little_person_guard")), "Elite Little Person Guard Spawn Egg");
        translationBuilder.add(ModLangUtils.getTranslationKey(ModEntities.THREE_COMPANIONS), "Three Companions");
        translationBuilder.add(ModLangUtils.getTranslationKey(ModItems.SPAWN_EGG_ITEMS.get("three_companions")), "Three Companions Spawn Egg");
        translationBuilder.add(ModLangUtils.getTranslationKey(ModEntities.GREEN_MAN), "Green Man");
        translationBuilder.add(ModLangUtils.getTranslationKey(ModItems.SPAWN_EGG_ITEMS.get("green_man")), "Green Man Spawn Egg");
        translationBuilder.add(ModLangUtils.getTranslationKey(ModEntities.LITTLE_PERSON_MEDIC), "Little Person Medic");
        translationBuilder.add(ModLangUtils.getTranslationKey(ModItems.SPAWN_EGG_ITEMS.get("little_person_medic")), "Little Person Medic Spawn Egg");
        translationBuilder.add(ModLangUtils.getTranslationKey(ModEntities.LITTLE_PERSON_GENERAL), "Little Person General");
        translationBuilder.add(ModLangUtils.getTranslationKey(ModItems.SPAWN_EGG_ITEMS.get("little_person_general")), "Little Person General Spawn Egg");
        translationBuilder.add(ModLangUtils.getTranslationKey(ModEntities.MACRO_SAMURAI), "Macro Samurai");
        translationBuilder.add(ModLangUtils.getTranslationKey(ModItems.SPAWN_EGG_ITEMS.get("macro_samurai")), "Macro Samurai Spawn Egg");
        ...
        translationBuilder.add(ModLangUtils.getTranslationKey(ModEffects.LITTLE_PERSON_GUARDIANSHIP), "Little Person Guardianship");
        translationBuilder.add(ModLangUtils.getTranslationKey(ModItems.SMALL_BACKPACK), "Small Backpack");
        translationBuilder.add(ModLangUtils.getTranslationKey(ModItems.BIG_BACKPACK), "Big Backpack");
        ...
        translationBuilder.add(ModLangUtils.getTranslationKey(ModItems.POISON_KNIFE), "Poison Knife");
        translationBuilder.add(ModLangUtils.getTranslationKey(ModItems.BLOOD_KNIFE), "Blood Knife");
        translationBuilder.add(ModLangUtils.getTranslationKey(ModItems.IRON_MAN_MISSILE_LAUNCHER), "Iron Man Missile Launcher");
        translationBuilder.add(ModLangUtils.getTranslationKey(ModItems.LITTLE_PERSON_TOOL), "Little Person Tool");
        ...
        translationBuilder.add(ModLangUtils.getTranslationKey(ModItems.ENDER_PURPLE_PEARL), "Ender Purple Pearl");
        ...
        translationBuilder.add(ModLangUtils.getTranslationKey(ModItems.SKULL_MAGE_SCROLL), "Skeleton Mage Scroll");
        ...
        translationBuilder.add(ModLangUtils.getTranslationKey(ModItems.COMPRESSED_COPPER_HELMET), "Compressed Copper Helmet");
        translationBuilder.add(ModLangUtils.getTranslationKey(ModItems.COMPRESSED_COPPER_CHESTPLATE), "Compressed Copper Chestplate");
        translationBuilder.add(ModLangUtils.getTranslationKey(ModItems.COMPRESSED_COPPER_LEGGINGS), "Compressed Copper Leggings");
        translationBuilder.add(ModLangUtils.getTranslationKey(ModItems.COMPRESSED_COPPER_BOOTS), "Compressed Copper Boots");
        ...
        translationBuilder.add(ModLangUtils.getTranslationKey(ModItems.COMPRESSED_COPPER_SWORD), "Compressed Copper Sword");
        ...
        translationBuilder.add(ModLangUtils.getTranslationKey(ModEntities.CHEST_GOLEM), "Chest Golem");
        translationBuilder.add(ModLangUtils.getTranslationKey(ModItems.SPAWN_EGG_ITEMS.get("chest_golem")), "Chest Golem Spawn Egg");
        translationBuilder.add(ModLangUtils.getTranslationKey(ModEntities.STRONG_MIN), "Strong Min");
        translationBuilder.add(ModLangUtils.getTranslationKey(ModItems.SPAWN_EGG_ITEMS.get("strong_min")), "Strong Min Spawn Egg");
