...
public class ModEffects {
    ...
    private static <T extends MobEffect> T register(String id, T effect) {
        return Registry.register(BuiltInRegistries.MOB_EFFECT, Identifier.fromNamespaceAndPath(Mob_battle.MOD_ID, id), effect);
    }

    private static Holder<MobEffect> getEntry(String id) {
        return BuiltInRegistries.MOB_EFFECT.get(Identifier.fromNamespaceAndPath(Mob_battle.MOD_ID, id))
