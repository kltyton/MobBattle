...
public class ModSounds {
    public static final Identifier DOG_JIAO_ID = Identifier.fromNamespaceAndPath(Mob_battle.MOD_ID, "dog_jiao");
    public static final Identifier ENGINEERS_SANCTUM = Identifier.fromNamespaceAndPath(Mob_battle.MOD_ID, "engineers_sanctum");
    public static final Identifier SHORELINE = Identifier.fromNamespaceAndPath(Mob_battle.MOD_ID, "shoreline");
    public static final Identifier GUN_SHOT = Identifier.fromNamespaceAndPath(Mob_battle.MOD_ID, "gun_shot");
    public static final Identifier GUN_RELOAD = Identifier.fromNamespaceAndPath(Mob_battle.MOD_ID, "gun_reload");
    public static final Identifier METEORITE = Identifier.fromNamespaceAndPath(Mob_battle.MOD_ID, "meteorite");
    public static final Identifier B_C_DOG_JIAO_ID = Identifier.fromNamespaceAndPath(Mob_battle.MOD_ID, "b_c_dog_jiao");
    public static final Identifier B_C_DEBUFF_DOG_JIAO_ID = Identifier.fromNamespaceAndPath(Mob_battle.MOD_ID, "b_c_debuff_dog_jiao");
    public static final Identifier B_C_BELLOW_DOG_JIAO_ID = Identifier.fromNamespaceAndPath(Mob_battle.MOD_ID, "b_c_bellow_dog_jiao");
    public static final Identifier B_C_Z_DOG_JIAO_ID = Identifier.fromNamespaceAndPath(Mob_battle.MOD_ID, "b_c_z_dog_jiao");
    public static final Identifier ENDER_DRAGON_SOUND_SKILL4_ID = Identifier.fromNamespaceAndPath(Mob_battle.MOD_ID, "ender_dragon_skill4");
    public static final Identifier ENDER_DRAGON_SOUND_SKILL5_ID = Identifier.fromNamespaceAndPath(Mob_battle.MOD_ID, "ender_dragon_skill5");
    public static final Identifier DRAGON_BGM_HALF_ID = Identifier.fromNamespaceAndPath(Mob_battle.MOD_ID, "dragon_bgm_half");
    public static final Identifier DRAGON_BGM_NORMAL_ID = Identifier.fromNamespaceAndPath(Mob_battle.MOD_ID, "dragon_bgm_normal");
    public static final Identifier PLAYER_ATTACK_ID = Identifier.fromNamespaceAndPath(Mob_battle.MOD_ID, "player_attack");
    public static final Identifier PLAYER_ATTACK_ID_4 = Identifier.fromNamespaceAndPath(Mob_battle.MOD_ID, "player_attack_4");
