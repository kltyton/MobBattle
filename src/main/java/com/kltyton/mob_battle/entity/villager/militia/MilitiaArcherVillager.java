...
public class MilitiaArcherVillager extends SnowGolem implements NeutralMob {
    ...
    public static boolean checkSnuffleSpawnRules(EntityType<MilitiaArcherVillager> snuffle, ServerLevelAccessor world, EntitySpawnReason spawnType, BlockPos pos, RandomSource random) {
