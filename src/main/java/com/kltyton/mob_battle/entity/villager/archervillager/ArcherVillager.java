...
public class ArcherVillager extends SnowGolem implements NeutralMob, GeoEntity {
    ...
    public static boolean checkSnuffleSpawnRules(EntityType<ArcherVillager> snuffle, ServerLevelAccessor world, EntitySpawnReason spawnType, BlockPos pos, RandomSource random) {
