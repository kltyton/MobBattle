...
public class MilitiaWarriorVillagerRenderer extends AgeableMobEntityRenderer<MilitiaWarriorVillager, VillagerEntityRenderState, VillagerResemblingModel> {
    ...
    public MilitiaWarriorVillagerRenderer(EntityRendererFactory.Context context) {
        super(
                context,
    ...
    @Override
    public void updateRenderState(MilitiaWarriorVillager villagerEntity, VillagerEntityRenderState villagerEntityRenderState, float f) {
