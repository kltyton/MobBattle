...
public class IronManBulletEntityRenderer extends EntityRenderer<IronManBulletEntity, TippableArrowRenderState> {
    public static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(Mob_battle.MOD_ID, "textures/entity/projectiles/iron_man_bullet.png");
    public static final Identifier TIPPED_TEXTURE = Identifier.withDefaultNamespace("textures/entity/projectiles/iron_man_bullet.png");
