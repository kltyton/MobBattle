...
public class IronManBulletEntityModel extends EntityModel<ArrowRenderState> {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        PartDefinition bb_main = modelPartData.addOrReplaceChild("bb_main", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -1.0F, -3.0F, 3.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
