...
public class IronManBulletEntity extends ProjectileEntity {
    @Nullable
    ...
    public IronManBulletEntity(EntityType<? extends IronManBulletEntity> entityType, World world) {
        super(entityType, world);
        this.noClip = true;
    }

    public IronManBulletEntity(World world, LivingEntity owner, Entity target, Direction.Axis axis) {
    ...
    protected void onEntityHit(EntityHitResult result) {
        ...
        if (damaged) {
            ...
            if (victim instanceof LivingEntity lv) {
                lv.addStatusEffect(
                        new StatusEffectInstance(StatusEffects.WEAKNESS,  5 * 20, 7),
