...
public class PoisonousBulletEntityRenderer extends EntityRenderer<LittleArrowEntity, TippableArrowRenderState> {
    public static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(Mob_battle.MOD_ID, "textures/entity/projectiles/poison_arrow.png");
    public static final Identifier TIPPED_TEXTURE = Identifier.withDefaultNamespace("textures/entity/projectiles/poison_arrow.png");
