...
public class LittleArrowEntityModel extends EntityModel<ProjectileEntityRenderState> {
    private final ModelPart bb_main;
    public LittleArrowEntityModel(ModelPart root) {
        super(root);
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData bb_main = modelPartData.addChild("bb_main", ModelPartBuilder.create().uv(2, 0).cuboid(0.0F, 0.0F, -1.0F, 0.0F, 1.0F, 2.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 0.0F, 0.0F));
