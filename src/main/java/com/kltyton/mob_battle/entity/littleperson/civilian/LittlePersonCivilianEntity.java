...
public class LittlePersonCivilianEntity extends VillagerEntity implements LittlePersonEntity {
    ...
    public EntityData initialize(ServerWorldAccess world, LocalDifficulty difficulty, SpawnReason spawnReason, @Nullable EntityData entityData) {
        ...
        this.setVillagerData(this.getVillagerData().withProfession(world.getRegistryManager(), VillagerProfession.NITWIT).withLevel(1));
        return data;
    }
    @Override
    ...
    public void setVillagerData(VillagerData villagerData) {
        // 强制只接受 NITWIT 职业
        super.setVillagerData(villagerData.withProfession(this.getWorld().getRegistryManager(), VillagerProfession.NITWIT));
    }
