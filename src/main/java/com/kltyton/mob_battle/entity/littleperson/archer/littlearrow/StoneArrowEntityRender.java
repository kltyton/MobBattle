...
public class StoneArrowEntityRender extends EntityRenderer<LittleArrowEntity, TippableArrowRenderState> {
    public static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(Mob_battle.MOD_ID, "textures/entity/projectiles/stone_arrow.png");
    public static final ResourceLocation TIPPED_TEXTURE = ResourceLocation.withDefaultNamespace("textures/entity/projectiles/stone_arrow.png");
    private final StoneArrowEntityModel model;

    public StoneArrowEntityRender(EntityRendererProvider.Context context) {
        super(context);
        this.model = new StoneArrowEntityModel(context.bakeLayer(ModModel.STONE_ARROW));
    }
    @Override
