...
public class GoldenTrailProjectileRenderer extends EntityRenderer<GoldenTrailProjectile, TippableArrowRenderState> {
    public static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(Mob_battle.MOD_ID, "textures/entity/projectiles/golden_trail_projectile.png");
    public static final Identifier TIPPED_TEXTURE = Identifier.withDefaultNamespace("textures/entity/projectiles/golden_trail_projectile.png");
