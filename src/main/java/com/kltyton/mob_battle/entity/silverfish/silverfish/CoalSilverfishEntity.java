...
public class CoalSilverfishEntity extends SilverfishEntity implements GeneralEntityOnlyOneSkill<CoalSilverfishEntity> {
    ...
    public static DefaultAttributeContainer.Builder createAttributes() {
        return SilverfishEntity.createSilverfishAttributes()
                .add(EntityAttributes.MAX_HEALTH, 700.0D)
                .add(EntityAttributes.ATTACK_DAMAGE, 60.0D)
