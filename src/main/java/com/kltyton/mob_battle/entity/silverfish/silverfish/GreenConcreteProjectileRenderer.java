...
public class GreenConcreteProjectileRenderer extends EntityRenderer<GreenConcreteProjectileEntity, ArrowRenderState> {
    private final BlockModelResolver blockModelResolver;
    private final BlockModelRenderState blockRenderState = new BlockModelRenderState();

    public GreenConcreteProjectileRenderer(EntityRendererProvider.Context context) {
        super(context);
    ...
    @Override
    public void extractRenderState(GreenConcreteProjectileEntity entity, ArrowRenderState state, float tickDelta) {
