...
public class BlueIronGolemEntityRenderer extends MobRenderer<BlueIronGolemEntity, IronGolemRenderState, IronGolemModel> {
    private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(Mob_battle.MOD_ID, "textures/entity/blue_iron_golem/blue_iron_golem.png");
    ...
    public Identifier getTextureLocation(IronGolemRenderState ironGolemEntityRenderState) {
        return TEXTURE;
    }
