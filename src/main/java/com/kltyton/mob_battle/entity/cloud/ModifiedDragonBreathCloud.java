package com.kltyton.mob_battle.entity.cloud;
    ...
    public void tick() {
        ...
        if (this.tickCount % 4 == 0) {
            ...
            for (LivingEntity living : serverWorld.getEntitiesOfClass(
                ...
                if (!living.isSpectator() && !(living instanceof EnderDragon)) {
                    if (!EntityQueries.isValidSummonCombatTarget(this, this.getOwner(), living)) continue;
