...
public class HighbirdTeenageEntityRenderer<R extends LivingEntityRenderState & GeoRenderState> extends GeoEntityRenderer<HighbirdTeenageEntity, R> {
    public HighbirdTeenageEntityRenderer(EntityRendererProvider.Context context) {
    ...
    protected void applyRotations(RenderPassInfo<R> renderPassInfo, PoseStack poseStack, float nativeScale) {
        ...
        if (renderState instanceof LivingEntityRenderState livingRenderState) {
            if (livingRenderState.isAutoSpinAttack) {
                ...
                poseStack.mulPose(Axis.YP.rotationDegrees(bedOrientation != null ? bedOrientation.toYRot() : rotationYaw));
