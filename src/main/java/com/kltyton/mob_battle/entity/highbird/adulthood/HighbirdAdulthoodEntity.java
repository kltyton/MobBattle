...
public class HighbirdAdulthoodEntity extends HighbirdBaseEntity {
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
        ...
        // 攻击控制器
        controllers.add(
                new AnimationController<>("anger_controller", GeoAnimationUtil::playTriggeredAnimationOrStop)
    ...
    @Override
    protected AABB getAttackBoundingBox(double scale) {
        AABB box = super.getAttackBoundingBox(scale);
