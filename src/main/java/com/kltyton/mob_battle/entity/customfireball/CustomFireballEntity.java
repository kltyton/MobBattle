...
public class CustomFireballEntity extends LargeFireball {
    ...
    protected void onHit(HitResult hitResult) {
        ...
        if (type == HitResult.Type.ENTITY) {
            ...
            if (entity.getType().builtInRegistryHolder().is(EntityTypeTags.REDIRECTABLE_PROJECTILE) && entity instanceof Projectile projectileEntity) {
                Entity owner = this.getOwner();
                projectileEntity.deflect(ProjectileDeflection.AIM_DEFLECT, owner, owner == null ? null : EntityReference.of(owner), true);
            }
