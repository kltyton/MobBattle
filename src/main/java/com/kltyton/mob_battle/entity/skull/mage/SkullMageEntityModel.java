...
public class SkullMageEntityModel extends GeoModel<SkullMageEntity> {
    private final Identifier model = Identifier.of(Mob_battle.MOD_ID, "skull_mage");
    private final Identifier animations = Identifier.of(Mob_battle.MOD_ID, "skull_mage");
    private final Identifier texture = Identifier.of(Mob_battle.MOD_ID, "textures/entity/skull/skull_mage.png");
