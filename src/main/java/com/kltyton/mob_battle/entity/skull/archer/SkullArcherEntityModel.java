...
public class SkullArcherEntityModel extends GeoModel<SkullArcherEntity> {
    private final Identifier model = Identifier.of(Mob_battle.MOD_ID, "skull_archer");
    private final Identifier animations = Identifier.of(Mob_battle.MOD_ID, "skull_archer");
    private final Identifier texture = Identifier.of(Mob_battle.MOD_ID, "textures/entity/skull/skull_archer.png");
