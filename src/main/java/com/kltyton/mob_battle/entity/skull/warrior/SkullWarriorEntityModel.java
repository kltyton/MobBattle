...
public class SkullWarriorEntityModel extends GeoModel<SkullWarriorEntity> {
    private final Identifier model = Identifier.of(Mob_battle.MOD_ID, "skull_warrior");
    private final Identifier animations = Identifier.of(Mob_battle.MOD_ID, "skull_warrior");
    private final Identifier texture = Identifier.of(Mob_battle.MOD_ID, "textures/entity/skull/skull_warrior.png");
